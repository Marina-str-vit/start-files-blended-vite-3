...
export default CountryInfo;
           ...
           {/* напр. у Швейцірії декілька мов, тому зробили стр.29 так ч-з join. так можна тому, що в файлі "Форма отримання даних" зроблено languages: Object.values(languages), */}
